...
EDGE_MISSION_PACKAGE_SCHEMA_VERSION = _mission_package.EDGE_MISSION_PACKAGE_SCHEMA_VERSION
EDGE_MISSION_PACKAGE_IDENTITY_SCHEMA_VERSION = (
    _mission_package.EDGE_MISSION_PACKAGE_IDENTITY_SCHEMA_VERSION
)
EDGE_MISSION_PACKAGE_COMPONENT_DIGESTS_SCHEMA_VERSION = (
    _mission_package.EDGE_MISSION_PACKAGE_COMPONENT_DIGESTS_SCHEMA_VERSION
)
...
_build_edge_mission_package_plan = _mission_package.build_edge_mission_package_plan
edge_mission_package_component_digests = (
    _mission_package.edge_mission_package_component_digests
)
edge_mission_package_identity_hash = _mission_package.edge_mission_package_identity_hash
